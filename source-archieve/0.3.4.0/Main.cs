...
namespace s649FR
{
    [BepInPlugin("s649_FloorRemoval", "s649 Floor Removal", "0.3.4.0")]  
        ...
        internal static bool MineFloorPrefix(Map __instance, Point point, Chara c, bool recoverBlock, bool removePlatform){//v0.3.4.0 ->internal  //v0.3.3.0 namefix
            ...
            */
            ...
            if(point.sourceFloor.id == 4){
                ...
                if(IsLuckNumber(num)){//v0.3.4.0
                    //ワアオー
                    Msg.Say("dropReward");
                }
                switch(num){//v0.3.4.0 edit
                    //SS rare
                    case 0 : t = (DLV >= 10)? ThingGen.Create("828") : ThingGen.Create("medal").SetNum(EClass.rnd(4) + 1);//うみみゃあkouun
                    break;
                    case 1 : t = (DLV >= 10)? ThingGen.Create("659") : ThingGen.Create("medal").SetNum(EClass.rnd(4) + 1);//iyashi 659
                    break;
                    case 2 : t = (DLV >= 10)? ThingGen.Create("758") : ThingGen.Create("medal").SetNum(EClass.rnd(4) + 1);//genso 758
                    break;
                    case 3 : t = (DLV >= 10)? ThingGen.Create("759") : ThingGen.Create("medal").SetNum(EClass.rnd(4) + 1);//daiti 759
                    break;
                    case 4 : t = (DLV >= 10)? ThingGen.Create("806") : ThingGen.Create("medal").SetNum(EClass.rnd(4) + 1);//syuukaku 806
                    break;
                    case 5 : t = (DLV >= 10)? ThingGen.Create("1190") : ThingGen.Create("medal").SetNum(EClass.rnd(4) + 1);//wind 1190
                    break;
                    case 6 : t = (DLV >= 10)? ThingGen.Create("1191") : ThingGen.Create("medal").SetNum(EClass.rnd(4) + 1);//machine 1191
                    break;
                    case 7 or 77 or 777 or 7777 or 77777 : seed = EClass.pc.LV * 1000;//v0.3.4.0 upper
